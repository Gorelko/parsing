            ...
            <div class="serviceBox">
                <div class="service-content">
                    ...
                    <table border="1" align="center">
                        ...
                        <form method="post" action="index2.html" enctype="multipart/form-data">
                            <tr>
                        ...
                        <form name="formIndex" method="post" action="parsing">
                            <tr>
                                <td>Выберите файл загруженный ранее на сервер для парсинга</td>
                                <td colspan="2">
                                    <select class="selectpicker" name="uploadFileEnd" id='uploadFileEnd'>
