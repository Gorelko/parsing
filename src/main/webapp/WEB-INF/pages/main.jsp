    ...
    <div class="row">
        ...
        <div class="col-md-4 col-sm-6">
            <div class="serviceBox">
                ...
                <div class="service-content">
                    <h3><a href="index3">Cross analysis</a></h3>
                    <p>Просмотреть собранную информацию после парсинга.</p>
                </div>
                <div class="read">
                    <a href="index3" class="btn btn-default">Перейти</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-4 col-sm-6">
            <div class="serviceBox">
                ...
                <div class="service-content">
                    <h3><a href="analysis">Price analysis</a></h3>
                    <p>Произвести анализ цен для нашего ассортимента.</p>
                </div>
                <div class="read">
                    <a href="analysis" class="btn btn-default">Перейти</a>
                </div>
            </div>
        </div>
